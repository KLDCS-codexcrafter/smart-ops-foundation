...
export const VEHICLE_FA_LINK_KEY = (entityCode: string): string => `vehicle_fa_links_${entityCode}`;
export const VEHICLE_UTILIZATION_KEY = (entityCode: string): string => `vehicle_utilization_records_${entityCode}`;
