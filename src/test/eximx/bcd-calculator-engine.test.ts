/**
 * @file        src/test/eximx/bcd-calculator-engine.test.ts
 * @purpose     TIER 1 · Engine test · bcd-calculator-engine.ts
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block A · Tier 1
 * @anchored    EX-11 · BCD calculator
 * @discipline  PURE TEST · 0 production code change · structural attestation
 */
import { describe, it, expect } from 'vitest';
import * as Engine from '@/lib/bcd-calculator-engine';

describe('bcd-calculator-engine · BCD calc · D-NEW-FF aware', () => {
