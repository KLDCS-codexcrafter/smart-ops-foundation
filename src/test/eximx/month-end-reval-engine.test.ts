/**
 * @file        src/test/eximx/month-end-reval-engine.test.ts
 * @purpose     TIER 1 · Engine test · month-end-reval-engine.ts
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block A · Tier 1
 * @anchored    EX-8 · Month-end reval
 * @discipline  PURE TEST · 0 production code change · structural attestation
 */
import { describe, it, expect } from 'vitest';
import * as Engine from '@/lib/month-end-reval-engine';

describe('month-end-reval-engine · AS 11 / Ind AS 21 MTM', () => {
