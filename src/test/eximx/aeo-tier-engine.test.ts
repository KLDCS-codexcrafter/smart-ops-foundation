/**
 * @file        src/test/eximx/aeo-tier-engine.test.ts
 * @purpose     TIER 1 · Engine test · aeo-tier-engine.ts
...
import * as Engine from '@/lib/aeo-tier-engine';

describe('aeo-tier-engine · AEO Tier Mapping FULL', () => {
