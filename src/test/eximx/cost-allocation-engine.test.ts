/**
 * @file        src/test/eximx/cost-allocation-engine.test.ts
 * @purpose     TIER 1 · Engine test · cost-allocation-engine.ts
...
import * as Engine from '@/lib/cost-allocation-engine';

describe('cost-allocation-engine · 4-Method Cost Allocation', () => {
