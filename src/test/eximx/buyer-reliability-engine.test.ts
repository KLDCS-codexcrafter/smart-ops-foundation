/**
 * @file        src/test/eximx/buyer-reliability-engine.test.ts
 * @purpose     TIER 1 · Engine test · buyer-reliability-engine.ts
...
import * as Engine from '@/lib/buyer-reliability-engine';

describe('buyer-reliability-engine · Buyer Reliability FULL', () => {
