/**
 * @file        src/test/eximx/carotar-roo-engine.test.ts
 * @purpose     TIER 1 · Engine test · carotar-roo-engine.ts
...
import * as Engine from '@/lib/carotar-roo-engine';

describe('carotar-roo-engine · CAROTAR FULL · Sec 28DA COO Risk', () => {
