/**
 * @file        src/test/eximx/dgft-scheme-engine.test.ts
 * @purpose     TIER 1 · Engine test · dgft-scheme-engine.ts
...
import * as Engine from '@/lib/dgft-scheme-engine';

describe('dgft-scheme-engine · DGFT PRIMARY', () => {
