/**
 * @file        src/test/eximx/duty-waterfall-engine.test.ts
 * @purpose     TIER 1 · Engine test · duty-waterfall-engine.ts
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block A · Tier 1
 * @anchored    EX-3 / EX-6 · #15 Customs Revaluation · D-NEW-FF carryover
 * @discipline  PURE TEST · 0 production code change · structural attestation
 */
import { describe, it, expect } from 'vitest';
import * as Engine from '@/lib/duty-waterfall-engine';

describe('duty-waterfall-engine · BCD/SWS/IGST/SAD ladder · D-NEW-FF carryover', () => {
