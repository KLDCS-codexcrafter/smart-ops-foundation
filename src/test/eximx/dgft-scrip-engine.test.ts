/**
 * @file        src/test/eximx/dgft-scrip-engine.test.ts
 * @purpose     TIER 1 · Engine test · dgft-scrip-engine.ts
...
import * as Engine from '@/lib/dgft-scrip-engine';

describe('dgft-scrip-engine · Scrip issuance + utilization', () => {
