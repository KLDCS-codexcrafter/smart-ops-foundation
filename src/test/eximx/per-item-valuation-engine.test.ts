/**
 * @file        src/test/eximx/per-item-valuation-engine.test.ts
 * @purpose     TIER 1 · Engine test · per-item-valuation-engine.ts
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block A · Tier 1
 * @anchored    EX-10 · D-NEW-FF SIBLING
 * @discipline  PURE TEST · 0 production code change · structural attestation
 */
import { describe, it, expect } from 'vitest';
import * as Engine from '@/lib/per-item-valuation-engine';

describe('per-item-valuation-engine · D-NEW-FF SIBLING keystone (Tier 1 surface)', () => {
