/**
 * @file        src/test/eximx/vendor-reliability-engine.test.ts
 * @purpose     TIER 1 · Engine test · vendor-reliability-engine.ts
...
import * as Engine from '@/lib/vendor-reliability-engine';

describe('vendor-reliability-engine · Vendor Reliability PRIMARY · MIRRORS buyer', () => {
