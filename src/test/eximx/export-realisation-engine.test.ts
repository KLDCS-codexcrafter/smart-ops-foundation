/**
 * @file        src/test/eximx/export-realisation-engine.test.ts
 * @purpose     TIER 1 · Engine test · export-realisation-engine.ts
...
import * as Engine from '@/lib/export-realisation-engine';

describe('export-realisation-engine · FEMA + Forex Triangulation', () => {
