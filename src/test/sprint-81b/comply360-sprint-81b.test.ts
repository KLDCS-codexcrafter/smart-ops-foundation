...
describe('Sprint 81b · T-Phase-5.B.2.2-PASS-B · Internal Audit Dashboard + AuditTrailExplorer + 2 DP-S79-2 stub fills', () => {
  ...
  // Lesson 24: Sprint 81c added Mock Audit (7th) · Sprint 81d added Reports & Handoff (8th) · bounds-check per FR-105 cascade discipline
  it('InternalAuditDashboardPage has at least 7 TabsTrigger (DP-S81-12 + DP-S81-13 · FR-106 12th scenario still holds)', () => {
    const src = fs.readFileSync(SRC('src/pages/erp/comply360/internal-audit/DashboardPage.tsx'), 'utf-8');
