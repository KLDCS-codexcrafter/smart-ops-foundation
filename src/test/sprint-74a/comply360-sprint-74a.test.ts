...
describe('Sprint 74a · buildGSTR9C engine smoke', () => {
  const baseGSTR9: GSTR9Payload = {
    ...
    tbl6: { pt6A: { iamt: 50_000, camt: 25_000, samt: 25_000, csamt: 0 } },
    tbl7: { pt7A: { iamt: 0, camt: 0, samt: 0, csamt: 0 } },
    tbl9: { tax_pay: { iamt: 90_000, camt: 45_000, samt: 45_000, csamt: 0 }, paid_itc: { iamt: 50_000, camt: 25_000, samt: 25_000, csamt: 0 } },
    tbl17: { hsn: {} },
  };
