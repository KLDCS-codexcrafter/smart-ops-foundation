/**
 * @file        src/test/eximx-persistence/dgft-scrip.test.ts
 * @purpose     TIER 2 · Persistence test · DGFT Schemes + Scrip · FR-26 entity-scoped
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block B
 * @anchored    EX-10 · Moat #20
 */
...
const SUFFIX = 'dgft_scrip';

describe('DGFT Schemes + Scrip persistence · FR-26 entity-scoped', () => {
