/**
 * @file        src/test/eximx-persistence/multileg-git.test.ts
 * @purpose     TIER 2 · Persistence test · Multi-Leg GIT · FR-26 entity-scoped
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block B
 * @anchored    EX-4 · Moat #1
 */
...
const SUFFIX = 'multileg_git';

describe('Multi-Leg GIT persistence · FR-26 entity-scoped', () => {
