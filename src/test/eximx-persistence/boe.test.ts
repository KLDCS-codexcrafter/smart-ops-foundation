/**
 * @file        src/test/eximx-persistence/boe.test.ts
 * @purpose     TIER 2 · Persistence test · Bill of Entry · FR-26 entity-scoped
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block B
 * @anchored    EX-6 · Moat #2
 */
...
describe('Bill of Entry persistence · FR-26 entity-scoped', () => {
