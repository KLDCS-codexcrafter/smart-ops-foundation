/**
 * @file        src/test/eximx-persistence/ci.test.ts
 * @purpose     TIER 2 · Persistence test · Commercial Invoice · FR-26 entity-scoped
...
const SUFFIX = 'commercial_invoice';

describe('Commercial Invoice persistence · FR-26 entity-scoped', () => {
