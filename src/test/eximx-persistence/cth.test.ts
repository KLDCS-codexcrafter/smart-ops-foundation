/**
 * @file        src/test/eximx-persistence/cth.test.ts
 * @purpose     TIER 2 · Persistence test · CTH × Country × Date · FR-26 entity-scoped
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block B
 * @anchored    EX-2 · Moat #8
 */
...
const SUFFIX = 'cth_history';

describe('CTH × Country × Date persistence · FR-26 entity-scoped', () => {
