/**
 * @file        src/test/eximx-persistence/tt-hedge.test.ts
 * @purpose     TIER 2 · Persistence test · TT Payments + Hedge · FR-26 entity-scoped
...
const SUFFIX = 'tt_hedge';

describe('TT Payments + Hedge persistence · FR-26 entity-scoped', () => {
