/**
 * @file        src/test/eximx-persistence/lut.test.ts
 * @purpose     TIER 2 · Persistence test · LUT Master · FR-26 entity-scoped
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block B
 * @anchored    EX-1 · Moat #4 LUT-as-Workflow
 */
...
const SUFFIX = 'lut_master';

describe('LUT Master persistence · FR-26 entity-scoped', () => {
