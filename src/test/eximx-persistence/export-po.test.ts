/**
 * @file        src/test/eximx-persistence/export-po.test.ts
 * @purpose     TIER 2 · Persistence test · Export PO · FR-26 entity-scoped
...
const SUFFIX = 'export_po';

describe('Export PO persistence · FR-26 entity-scoped', () => {
