/**
 * @file        src/test/eximx-persistence/foreign-parties.test.ts
 * @purpose     TIER 2 · Persistence test · Foreign Customer/Vendor · FR-26 entity-scoped
...
const SUFFIX = 'foreign_parties';

describe('Foreign Customer/Vendor persistence · FR-26 entity-scoped', () => {
