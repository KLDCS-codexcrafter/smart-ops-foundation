/**
 * @file        src/test/eximx-persistence/iec.test.ts
 * @purpose     TIER 2 · Persistence test · IEC Master · FR-26 entity-scoped
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block B
 * @anchored    EX-1 · Moat #4
 */
...
const SUFFIX = 'iec_master';

describe('IEC Master persistence · FR-26 entity-scoped', () => {
