/**
 * @file        src/test/eximx-persistence/realisation.test.ts
 * @purpose     TIER 2 · Persistence test · Export Realisation + e-BRC + FIRC · FR-26 entity-scoped
 * @sprint      T-Phase-2.TB-1-EximX-Test-Bolster · Sprint 37 · Block B
 * @anchored    EX-7c · Moat #19
 */
...
const SUFFIX = 'realisation';

describe('Export Realisation + e-BRC + FIRC persistence · FR-26 entity-scoped', () => {
