/**
 * @file        src/test/eximx-persistence/import-po.test.ts
 * @purpose     TIER 2 · Persistence test · Import PO · FR-26 entity-scoped
...
const SUFFIX = 'import_po';

describe('Import PO persistence · FR-26 entity-scoped', () => {
