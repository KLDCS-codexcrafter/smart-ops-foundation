...
export const SPRINTS: SprintEntry[] = [
  ...
  // 🆕 Sprint W1C-8 T-W1C8-SigmaFlow-Scenario · Wave-1 Close Arc · 8th /welcome/scenarios blueprint · adds SigmaFlow Control India (Kolkata · DI valves + water-works fittings · ISO 9001 · BIS · British-Standard · Sigma Corp USA collaboration · PQRS mantra · ~74 employees · imports DI castings) as the 8th blueprint with a NEW additive 'valve-mfg' archetype value on DemoArchetype · DEMO_ITEMS_VALVE_MFG (15 items · real HSN 8481 valves + 7307 fittings + 4016 EPDM seat + 7318 fasteners + 7325 DI castings · 18% GST) wired via itemsForArchetype · 4 valve-mfg customers (KMC Water Supply · WB PHED · L&T WET · VA Tech Wabag) + 4 valve-mfg vendors (Eastern DI Foundry · Sigma Corp USA Import · Polymech Rubber · Ludhiana Fastener Works) tagged _archetype:'valve-mfg' via the existing filter · DEMO_BOM_VALVE_MFG (DN100 PN16 butterfly valve · 5 components referencing Block-1 raw items · BS-EN-593 face-to-face) seeded under erp_bom_{entity} when archetype === 'valve-mfg' (single conditional swap on existing safeSetArray write) · the 3 existing archetypes (trading/services/manufacturing) + their data 0-DIFF · the 7 existing blueprints (abdos/cherise/bcpl/smartpower/amith/shankar-pharma/sinha) 0-DIFF (zero changes to ids/titles/archetypes/entityCodes) · seed flows through the EXISTING seedEntityDemoData orchestrator — ZERO new seed logic · ZERO new SIBLINGs (only an archetype enum value · 4 new data exports · 1 blueprint row · 1 conditional in the BOM seed write) · walls held: demo-seed-orchestrator core logic CONSUMED 0-DIFF · all card engines + pages 0-DIFF · all banked surfaces 0-DIFF · headSha TBD_AT_BANK
  {
    sprintNumber: 'W1C8' as unknown as number, code: 'T-W1C8-SigmaFlow-Scenario', composite: false, grade: 'A',
    headSha: 'TBD_AT_BANK', predecessorSha: '8ee1757', loc: 220,
    newSiblings: [],
    bankDate: '2026-06-13', provenance: 'CONFIRMED',
  },
];
