...
export const SPRINTS: SprintEntry[] = [
  ...
  // 🆕 Sprint RPT-7b T-RPT7b-SalesX-Analytical-ProjX · Reporting Arc · Phase C (Sales Hub cohort b + ProjX) · 12 pages chart-enabled across SalesX analytical (6) + ProjX (7−1 excluded) — TOGGLE recipe (8 pages with shadcn <Table>): TargetVsAchievement (21) · PipelineSummary (15) · CoverageReport (22) · BeatProductivityReport (21) · SecondarySalesReport (35) · CrossDeptHandoffTracker (31) · ProjectRegister (15) · ProjxDocumentsRegister (19) — DASHBOARD recipe (4 pages with 0 shadcn <Table>): ProjectPnLReport (0) · ProjectMarginReport (0) · MilestoneStatusReport (0) · ResourceUtilizationReport (0) — EXCLUDED 0-DIFF: CashFlowProjectionReport (legacy-recharts) · 13 layer-tagged KPI seeds (sx-target-ach[thresholds higher-good 75/50] · sx-pipeline · sx-coverage · sx-beat · sx-secondary-rpt · sx-handoff · px-projects · px-pnl · px-margin[thresholds higher-good 25/10] · px-cashflow · px-milestones · px-utilization · px-documents) · 2 ProjX DSC sources (projx.projects wrapping projectsKey · projx.financials wrapping projectMilestonesKey) — SalesX sources REUSED via dataSource pointers (no duplication) · ScorecardTile OMITTED across all 12 pages — no real bounded summary-% available · hooks at top level · NO recharts import added · layouts PRESERVED (additive Card after existing content) · honest empty-state · ZERO new SIBLINGs · headSha TBD_AT_BANK
  {
    sprintNumber: 'RPT7b' as unknown as number, code: 'T-RPT7b-SalesX-Analytical-ProjX', composite: false, grade: 'A',
    headSha: 'TBD_AT_BANK', predecessorSha: '056371b', loc: 1080,
    newSiblings: [],
