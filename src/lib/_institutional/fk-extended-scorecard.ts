 ...
 * @sprint      T-Phase-4.FAR-0 · Theme 7 · D-FAR-v4-26 · Q-LOCK-6 A
 */
...
export const FK_CAPABILITIES: FKCapability[] = [
  ...
  { id: 'FK-CAP-2', name: 'Machine (Production) ↔ Fixed Asset (bidirectional UI)', state: 'partial', lastChangedSprint: null, schemaFile: 'src/types/machine.ts (fixed_asset_id · EXISTING)', uiClosedAtSprint: null },
  ...
  { id: 'FK-CAP-6', name: 'Production sidebar Machine List + FA-linked Machines report', state: 'absent', lastChangedSprint: null, schemaFile: 'N/A · UI at FAR-2', uiClosedAtSprint: null },
  ...
  { id: 'FK-CAP-8', name: 'FA Register → Linked Machines reverse-display', state: 'absent', lastChangedSprint: null, schemaFile: 'N/A · UI at FAR-2', uiClosedAtSprint: null },
];
