...
describe('Institutional registers · cardinality (post-Sprint-74a Comply360 Main Arc 1.6 Pass A)', () => {
  it('SIBLINGS has 73 entries', () => {
    expect(getSiblingCount()).toBe(73);
  });
  ...
  it('SPRINTS has 76 entries', () => {
    expect(getSprintCount()).toBe(76);
  });
...
describe('Sprint history · A-streak counter', () => {
  ...
  it('current A-streak is at least 23 (Sprint 54-74a · NEW Operix record ⭐)', () => {
