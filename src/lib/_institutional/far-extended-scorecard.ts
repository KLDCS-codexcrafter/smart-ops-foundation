...
export const FAR_CAPABILITIES: FARCapability[] = [
  ...
  // FAR-CAP-7..24 absent
  { id: 'FAR-CAP-7', name: 'Indian Statutory Auto-Pack · TDS + TCS + GST FA', state: 'absent', lastChangedSprint: null, evidenceFiles: [], parentTheme: 'far-1-statutory' },
  { id: 'FAR-CAP-8', name: 'Schedule III FA disclosure auto-generation', state: 'absent', lastChangedSprint: null, evidenceFiles: [], parentTheme: 'far-1-statutory' },
  { id: 'FAR-CAP-9', name: 'Ind AS 16 / AS 10 PP&E disclosure', state: 'absent', lastChangedSprint: null, evidenceFiles: [], parentTheme: 'far-1-statutory' },
  { id: 'FAR-CAP-10', name: 'Component accounting (Schedule II)', state: 'absent', lastChangedSprint: null, evidenceFiles: [], parentTheme: 'far-1-statutory' },
  { id: 'FAR-CAP-11', name: 'EquipmentMaster FA picker UI', state: 'absent', lastChangedSprint: null, evidenceFiles: [], parentTheme: 'far-2-fk-ui' },
