...
export const FAR_CAPABILITIES: FARCapability[] = [
  ...
  { id: 'FAR-CAP-11', name: 'EPCG export-obligation bridge (FA ↔ EximX)', state: 'full', lastChangedSprint: 65, evidenceFiles: ['src/lib/epcg-fa-bridge.ts','src/pages/erp/fincore/statutory-fa-pack/EPCGStatusReport.tsx'], parentTheme: 'far-2-fk-ui' },
