...
// 🎬 Sprint 137 · T-TaskFlow-A641.1 · Pillar A.6.4 · TaskFlow Arc opener (post-Phase-7)
const TaskFlowPage = lazy(() => import('./pages/erp/taskflow/TaskFlowPage'));
const TaskRoomPage = lazy(() => import('./pages/erp/taskflow/TaskRoomPage'));
...
// Sprint 153 · EcomX Channel Foundation · DP-EC-1 rename ceremony
const EcomXPage = lazy(() => import('./pages/erp/ecomx/EcomXPage'));
...
// 🆕 RPT-9c · Logistic Report Builder (route-mode mount · cardId="logistics")
const LogisticReportBuilder = lazy(() => import('./pages/erp/logistic/LogisticReportBuilder'));
        ...
        <BrowserRouter>
          ...
          <Suspense fallback={<div className="flex items-center justify-center h-screen"><div className="animate-spin h-8 w-8 border-4 border-primary border-t-transparent rounded-full" /></div>}>
            <Routes>
              ...
              <Route path="/erp/webstorex/*" element={<P><WebStoreXPage /></P>} />
              {/* Sprint 153 · EcomX Channel Foundation */}
              <Route path="/erp/ecomx" element={<P><EcomXPage /></P>} />
              <Route path="/erp/ecomx/*" element={<P><EcomXPage /></P>} />
