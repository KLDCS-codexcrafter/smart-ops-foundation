...
export const SINHA_HEDGE_CONTRACTS: HedgeContract[] = [
  ...
  { id: 'hc-sinha-003', hedge_contract_no: 'HC-SINHA-2026-003', entity_id: 'sinha-trading', status: 'open', direction: 'forward_sell', ad_bank_code: 'SBININBB', ad_bank_name: 'State Bank of India', currency_code: 'USD', notional_amount_foreign: 75000, forward_rate_locked: 85.80, notional_amount_inr_at_lock: 6435000, booking_date: '2026-03-15', maturity_date: '2026-09-15', settlement_date: null, linked_export_po_id: 'expo-sinha-001', linked_import_po_id: null, is_speculative: false, spot_rate_at_maturity: null, settlement_variance_inr: 0, notes: 'Q1 FY26-27 effective hedge · spans Apr-Sep · D-NEW-FB demo for quarter-end accrual', created_at: now, updated_at: now },
];
