...
export const VOUCHER_TYPE_SEEDS: VoucherType[] = [
  ...
  seed('vt-journal', {
    ...
    voucher_classes: [
      {
        class_id: 'jv-accrual',
        class_name: 'Accrual Journal',
        abbreviation_prefix: 'JV-ACCR',
        numbering_width: 4, numbering_prefill_zeros: true, numbering_start: 1, current_sequence: 1,
        fy_scoped: true,
        feature_namespace: 'loan-emi',
        is_active: true, is_system: true,
        created_at: now, updated_at: now,
      },
      {
        class_id: 'jv-bounce',
        class_name: 'Bounce Journal',
        abbreviation_prefix: 'JV-BNC',
        numbering_width: 4, numbering_prefill_zeros: true, numbering_start: 1, current_sequence: 1,
        fy_scoped: true,
        feature_namespace: 'loan-emi',
        is_active: true, is_system: true,
      ...
      {
        class_id: 'jv-notional-interest',
        class_name: 'Notional Interest Journal',
        abbreviation_prefix: 'JV-NOT',
        numbering_width: 4, numbering_prefill_zeros: true, numbering_start: 1, current_sequence: 1,
        fy_scoped: true,
        feature_namespace: 'loan-emi',
        is_active: true, is_system: true,
      ...
      {
        class_id: 'jv-penal',
        class_name: 'Penal Journal',
        abbreviation_prefix: 'JV-PNL',
        numbering_width: 4, numbering_prefill_zeros: true, numbering_start: 1, current_sequence: 1,
        fy_scoped: true,
        feature_namespace: 'loan-emi',
        is_active: true, is_system: true,
      ...
      {
        class_id: 'jv-processing-fee',
        class_name: 'Processing Fee Journal',
        abbreviation_prefix: 'JV-PF',
        numbering_width: 4, numbering_prefill_zeros: true, numbering_start: 1, current_sequence: 1,
        fy_scoped: true,
        feature_namespace: 'loan-emi',
        is_active: true, is_system: true,
      ...
      {
        class_id: 'jv-rcm',
        class_name: 'RCM Journal',
        abbreviation_prefix: 'JV-RCM',
        numbering_width: 4, numbering_prefill_zeros: true, numbering_start: 1, current_sequence: 1,
        fy_scoped: true,
        feature_namespace: 'gst-rcm',
        is_active: true, is_system: true,
        created_at: now, updated_at: now,
      },
    ],
