  ...
  },
  {
    ...
    children: [
      ...
      { id: 'multi-source-recommendations', type: 'item', label: 'Multi-Source Recs',
        icon: TrendingUp, moduleId: 'multi-source-recommendations', requiredCards: ['procure360'] },
      ...
      { id: 'vendor-reliability', type: 'item', label: 'Vendor Reliability',
        icon: Award, moduleId: 'vendor-reliability', requiredCards: ['procure360'] },
      ...
      { id: 'peq-followup', type: 'item', label: 'PEQ Followup (Action)',
        icon: Activity, moduleId: 'peq-followup', requiredCards: ['procure360'] },
      ...
      { id: 'purchase-cost-variance-item', type: 'item', label: 'Cost Variance · Item',
        icon: AlertTriangle, moduleId: 'purchase-cost-variance-item', requiredCards: ['procure360'] },
