...
export const servicedeskSidebarItems: SidebarItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'commission-settings', type: 'item', label: 'Commission Rates', moduleId: 'commission-settings', requiredCards: ['servicedesk'], keyboard: 'd g c' },
      ...
      { id: 'email-templates', type: 'item', label: 'Email Templates', moduleId: 'email-templates', requiredCards: ['servicedesk'], keyboard: 'd g e' },
      { id: 'tellicaller-triggers', type: 'item', label: 'Tellicaller Triggers', moduleId: 'tellicaller-triggers', requiredCards: ['servicedesk'], keyboard: 'd g t' },
      { id: 'call-type-master', type: 'item', label: 'Call Type Master', moduleId: 'call-type-master', requiredCards: ['servicedesk'], keyboard: 'd g m' },
