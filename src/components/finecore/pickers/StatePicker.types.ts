/**
 * @file     StatePicker.types.ts
 * @purpose  StateRow interface and INDIA_STATES constant extracted from
 *           StatePicker.tsx to satisfy react-refresh/only-export-components.
 ...
 * @whom     StatePicker.tsx · GST/place-of-supply consumers
 * @depends  none
 */
