...
const MOBILE_PRODUCTS: MobileProduct[] = [
  ...
  },
  {
    ...
    details: 'Live: A.15b · AM.2c flip. Landing wired to 4 institutional 5-step captures (DPR · Snag · Safety · Material Issue) each consuming sitex-engine + geolocation-bridge fence + camera-bridge photos + offline-queue-engine. PWA — no install.',
  ...
  },
  {
    ...
    icon: Wrench,
    description: 'Field-first mobile for maintenance technicians · 4 captures live (breakdown · PM tick-off · spares issue · asset photo). Active WO / today PM / open ticket summary tiles live.',
    details: 'Live: A.17 · AM.2c flip. 4 captures wired (MobileBreakdownCapture · MobilePMTickoffCapture · MobileSparesIssueCapture · MobileAssetPhotoCapture) each consuming maintainpro-engine + camera-bridge + offline-queue-engine. PWA — no install.',
  ...
  },
  {
    ...
    icon: Factory,
    description: 'Operator hands-free shop floor · voice-input production confirmation · barcode scan for materials/PO/asset · offline-resilient.',
    details: 'Live: A.PROD-3 · AM.2c flip. Voice input + barcode scan via camera-bridge consume production-confirmation-engine. Live OEE + machine-health IoT arrives with Wave-2 — honest banner shown on the landing.',
