/**
 * MobileQuickEnquiryPage.tsx — Field-call quick enquiry capture
 * Sprint T-Phase-1.1.1l-a · Reuses Enquiry + enquiriesKey
 */
...
export default function MobileQuickEnquiryPage() {
  ...
  const handleSubmit = useCallback(() => {
    ...
    const enquiry: Enquiry = {
      ...
      enquiry_source_name: 'Field-Call',
      priority,
      campaign: null,
      customer_id: null,
      customer_name: null,
  ...
  return (
    <div className="p-4 max-w-md mx-auto space-y-3">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h1 className="text-base font-semibold">Quick Enquiry</h1>
      </div>
