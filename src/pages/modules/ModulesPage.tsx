...
const MODULES: StandaloneModule[] = [
  ...
  {
    id: 'hr-standalone',
    title: 'HR & Attendance Standalone',
    icon: Users,
    description: 'Attendance tracking, leave management, and employee records without full payroll.',
    details: 'Planned: Biometric/app-based attendance, leave approval workflow, employee self-service portal, and basic HR reports. Designed for companies on Tally payroll who need HR automation.',
    route: '/modules/hr',
    phase: 'planned',
  },
  {
