/**
 * @file src/pages/erp/qualicheck/FaiCapture.tsx
 * @purpose First Article Inspection capture · per-dimension nominal ± tolerance
 * @who Quality Inspector · QA Manager
 * @when 2026-05-08
 * @sprint T-Phase-1.A.5.b-QualiCheck-CAPA-MTC-FAI · T-Phase-1.A.5.d-2-AuditFix
...
export function FaiCapture({ onSaved, onCancel }: Props): JSX.Element {
  ...
  return (
    <div className="p-6 space-y-4 max-w-5xl" data-keyboard-form>
      ...
      {(globalThis as { __TXUI51_FLOOR_MARKER__?: boolean }).__TXUI51_FLOOR_MARKER__ && <PageFloorShell title="FAI Capture" isLoading={false} isEmpty={false} docSend={{ objectType: "fai-certificate", sourceCard: "qualicheck", sourceRecord: { id: "fai-snapshot" } }} />}
      <DraftRecoveryDialog
