/**
 * @file src/pages/erp/qualicheck/reports/EffectivenessVerificationDuePanel.tsx
 * @purpose List of CAPA effectiveness verifications (30/60/90-day) due within window
 * @who Quality Inspector · QA Manager
 * @when 2026-05-08
 * @sprint T-Phase-1.A.5.b-QualiCheck-CAPA-MTC-FAI · Block F.2 · T-Phase-1.A.5.d-2-AuditFix
 ...
 * @[JWT] reads via capa-engine.listVerificationsDueWithin · GET /api/qualicheck/capas/verifications/due
 */
