/**
 * @file src/pages/erp/qualicheck/reports/ReprocessReport.tsx
 ...
 * @reuses listNcrs · findReworkJobCardsForNcr (qualicheck-bridges · Q-LOCK-4 Path B)
...
import { findReworkJobCardsForNcr, type ReworkJobCardMatch } from '@/lib/qualicheck-bridges';
