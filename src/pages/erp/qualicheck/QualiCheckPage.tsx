 ...
 * @purpose     QualiCheck card page using canonical Shell pattern (FR-58 · GateFlow precedent)
 ...
 * @reuses      @/shell Shell · qualicheck-shell-config · panels · operational-panels
 * @[JWT]       Multiple via panels (see panel files for endpoints)
 */
import { useEffect, useState } from 'react';
import { Shell } from '@/shell';
import { qualicheckShellConfig } from '@/apps/erp/configs/qualicheck-shell-config';
...
export default function QualiCheckPage(): JSX.Element {
  ...
  // α-a-bis · D-NEW-AW · mount Procure360 → QualiCheck QA handoff listener
  useEffect(() => {
    const unmount = mountQualiCheckBridges();
