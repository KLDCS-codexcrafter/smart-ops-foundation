/**
 * @file src/pages/erp/qualicheck/NcrCapture.tsx
 * @purpose Manual NCR entry form · FR-29 carry-forward mounts (12/12)
 * @who Quality Inspector · QA Manager
 * @when 2026-05-08
 * @sprint T-Phase-1.A.5.a-bis-QualiCheck-NCR-Foundation · T-Phase-1.A.5.d-2-AuditFix
 ...
 * @[JWT] localStorage via raiseNcr · POST /api/qualicheck/ncrs
...
export function NcrCapture({ onSaved, onCancel }: Props): JSX.Element {
  ...
  return (
    <div className="p-6 space-y-4 max-w-4xl" data-keyboard-form>
      ...
      />
      <Sprint27d2Mount formName="NCR Capture" entityCode={entityCode} items={[]} isLineItemForm={false} />
      <Sprint27eMount
        entityCode={entityCode}
        voucherTypeId="ncr"
        voucherTypeName="NCR Capture"
