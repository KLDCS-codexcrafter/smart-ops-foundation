/**
 * ReceiptPrint.tsx — A4 printable Receipt voucher.
 * Reads voucher_id from query string. Uses receipt-print-engine payload.
 */
...
export function ReceiptPrintPanel() {
  ...
  useEffect(() => {
    ...
    setPayload(buildReceiptPrintPayload(voucher, gst, copyKey));
