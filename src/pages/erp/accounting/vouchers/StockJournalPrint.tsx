/**
 * StockJournalPrint.tsx — A4 printable Stock Journal voucher.
 */
...
function LineTable({ title, lines, total, prefix }: {
  title: string; lines: StockJournalPrintLine[]; total: number; prefix: string;
}) {
  return (
    <div>
        ...
        <table className="w-full text-[10px] border-collapse">
          ...
          <tbody>
            ...
            <tr className="bg-muted/30 font-semibold">
              <td className="border border-border p-1.5" colSpan={3}>Subtotal</td>
...
export function StockJournalPrintPanel() {
  ...
  useEffect(() => {
    ...
    setPayload(buildStockJournalPrintPayload(voucher, gst, copyKey));
