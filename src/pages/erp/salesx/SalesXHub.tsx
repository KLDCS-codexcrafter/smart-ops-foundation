...
const TYPE_BADGE: Record<SAMPersonType, string> = {
  ...
  project_manager:           'bg-purple-500/15 text-purple-600 border-purple-500/30',
  service_engineer:          'bg-cyan-500/15 text-cyan-600 border-cyan-500/30',
  service_call_center_agent: 'bg-pink-500/15 text-pink-600 border-pink-500/30',
};
