    ...
    <div className="space-y-4" data-keyboard-form>
      ...
      <Card>
        <CardContent className="p-4">
          <GSTBillShipSection
            customerId={selectedSO?.party_id ?? null}
            customerName={selectedSO?.party_name ?? null}
