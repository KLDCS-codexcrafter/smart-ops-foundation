...
export function SampleOutwardMemoPanel({ entityCode }: Props) {
  ...
  return (
    <div className="space-y-4" data-keyboard-form>
      ...
      <Sprint27eMount
        entityCode={typeof entityCode === 'string' ? entityCode : ''}
        voucherTypeId="SAMPLE_OUTWARD"
        voucherTypeName="Sample Outward Memo"
      ...
      <TallyVoucherHeader
        ...
        voucherFamily="sample_outward_memo"
        voucherNo={memoNo}
