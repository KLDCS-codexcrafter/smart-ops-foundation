...
const _VC_FAMILY_27B = 'sales_demo' as const;
...
export function DemoOutwardMemoPanel({ entityCode }: Props) {
  ...
  return (
    <div className="space-y-4" data-keyboard-form>
      ...
      <Sprint27eMount
        entityCode={typeof entityCode === 'string' ? entityCode : ''}
        voucherTypeId="DEMO_OUTWARD"
        voucherTypeName="Demo Outward Memo"
