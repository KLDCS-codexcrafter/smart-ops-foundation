/**
 * SalesOrderDetailPanel.tsx — UPRA-4 Phase B · NEW
 * Order detail panel · self-contained (inline Field/dash/STATUS maps).
 */
...
export interface SalesOrderDetailPanelProps {
  order: Order;
  onPrint: () => void;
}

export function SalesOrderDetailPanel({ order, onPrint }: SalesOrderDetailPanelProps): JSX.Element {
    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-3">
          ...
          <Field label="Customer PO" value={`${dash(order.ref_no)}${order.ref_date ? ` (${order.ref_date})` : ''}`} />
