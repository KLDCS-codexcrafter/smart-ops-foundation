...
export function CycleCountEntryPanel() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <TallyVoucherHeader voucherTypeName="Cycle Count" baseVoucherType="Memo" voucherFamily="cycle_count" voucherNo="" voucherDate={new Date().toISOString().slice(0,10)} status="draft" />
      ...
      <Sprint27eMount
        entityCode={typeof entityCode === 'string' ? entityCode : ''}
        voucherTypeId="CYCLE_COUNT"
        voucherTypeName="Cycle Count"
    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <Input type="date" value={effectiveDate}
          ...
          onChange={e = onKeyDown={onEnterNext} > setEffectiveDate(e.target.value)} />
                ...
                <TableCell className="text-right">
                  {isDraft ? (
                    <Input type="number" className="h-7 w-24 text-right font-mono text-xs"
                      ...
                      onChange={(e) = onKeyDown={onEnterNext} > setLineQty(l.id, parseFloat(e.target.value) || 0)} />
