      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-3 gap-3">
          ...
          <div>
            ...
            <Input value={subType} onChange={e => setSubType(e.target.value)}  onKeyDown={onEnterNext} />
          </div>
          <div>
              ...
              {lines.map(l => (
                <div key={l.id} className="grid grid-cols-12 gap-2 items-end border-b pb-2">
                  <div className="col-span-3">
                    ...
                    <Input value={l.item_name} onChange={e => updateLine(l.id, { item_name: e.target.value, item_id: e.target.value })}  onKeyDown={onEnterNext} />
                  </div>
                  ...
                  <div className="col-span-1">
                    ...
                    <Input type="number" inputMode="decimal" value={l.qty} onChange={e => updateLine(l.id, { qty: Number(e.target.value) })}  onKeyDown={onEnterNext} />
                  </div>
                  <div className="col-span-1">
                  ...
                  <div className="col-span-2">
                    ...
                    <Input type="number" inputMode="decimal" value={l.estimated_rate} onChange={e => updateLine(l.id, { estimated_rate: Number(e.target.value) })}  onKeyDown={onEnterNext} />
                  </div>
                  <div className="col-span-2">
