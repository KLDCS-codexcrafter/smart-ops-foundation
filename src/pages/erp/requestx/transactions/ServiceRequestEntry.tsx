                ...
                <TableBody>
                  {lines.map(l => (
                    <TableRow key={l.id}>
                      ...
                      <TableCell>
                        <Input value={l.service_name} onChange={e => updateLine(l.id, { service_name: e.target.value, service_id: e.target.value })} placeholder="Service"  onKeyDown={onEnterNext} />
                      </TableCell>
                      <TableCell><Input value={l.description} onChange={e => updateLine(l.id, { description: e.target.value })}  onKeyDown={onEnterNext} /></TableCell>
