      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input type="number" min={1} value={plannedQty} onChange={e = onKeyDown={onEnterNext} > setPlannedQty(Number(e.target.value))} className="font-mono" />
          </div>
          <div className="space-y-2">
            <Label>UOM</Label>
          ...
          <div className="space-y-2">
            ...
            <Input type="date" value={startDate} onChange={e = onKeyDown={onEnterNext} > setStartDate(e.target.value)} className="font-mono" />
          </div>
          <div className="space-y-2">
            <Label>Target End Date</Label>
            <Input type="date" value={targetEnd} onChange={e = onKeyDown={onEnterNext} > setTargetEnd(e.target.value)} className="font-mono" />
          </div>
