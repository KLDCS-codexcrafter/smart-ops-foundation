      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input type="date" className="font-mono" value={confirmDate} onChange={e = onKeyDown={onEnterNext} > setConfirmDate(e.target.value)} />
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input className="font-mono" value={batchNo} onChange={e = onKeyDown={onEnterNext} > setBatchNo(e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label>Heat No</Label>
              <Input className="font-mono" value={heatNo} onChange={e = onKeyDown={onEnterNext} > setHeatNo(e.target.value)} />
            </div>
            <div className="md:col-span-2 space-y-2">
              <Label>Remarks</Label>
              <Input value={remarks} onChange={e = onKeyDown={onEnterNext} > setRemarks(e.target.value)} />
            </div>
            <div className="md:col-span-2 space-y-2">
              <Label>Notes</Label>
