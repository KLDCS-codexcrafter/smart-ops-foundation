      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input type="date" className="font-mono" value={jwoDate} onChange={e => setJwoDate(e.target.value)}  onKeyDown={onEnterNext} />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input type="date" className="font-mono" value={returnDate} onChange={e => setReturnDate(e.target.value)}  onKeyDown={onEnterNext} />
          </div>
