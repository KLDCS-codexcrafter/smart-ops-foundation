        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              ...
              <Input type="number" min="0" value={editing?.planned_qty ?? plannedQty} onChange={e = onKeyDown={onEnterNext} > setPlannedQty(e.target.value)} disabled={!!editing} />
            </div>
            <div>
          ...
          {editing && (editing.status === 'in_progress' || editing.status === 'on_hold') && (
            <Card>
              ...
              <CardContent className="grid grid-cols-3 gap-3">
                <div><Label className="text-xs">Produced Qty</Label><Input type="number" value={producedQty} onChange={e = onKeyDown={onEnterNext} > setProducedQty(e.target.value)} /></div>
                <div><Label className="text-xs">Rejected Qty</Label><Input type="number" value={rejectedQty} onChange={e = onKeyDown={onEnterNext} > setRejectedQty(e.target.value)} /></div>
