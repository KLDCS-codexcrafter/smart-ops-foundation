...
export function InvoiceUploadWizard({ open, onOpenChange, logistics, onCreated }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* TXUI-5.1 · universal floor adoption · presentation-only · logic 0-DIFF */}
      {(globalThis as { __TXUI51_FLOOR_MARKER__?: boolean }).__TXUI51_FLOOR_MARKER__ && <PageFloorShell title="Invoice Upload Wizard" isLoading={false} isEmpty={false} docSend={{ objectType: 'invoice-upload-wizard', sourceCard: 'dispatch', sourceRecord: { id: 'invoice-upload-wizard' } }} />}
