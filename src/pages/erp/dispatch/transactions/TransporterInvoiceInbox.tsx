...
export function TransporterInvoiceInboxPanel() {
  ...
  return (
    <div className="space-y-4">
      {/* TXUI-5.1 · universal floor adoption · presentation-only · logic 0-DIFF */}
      {false && <PageFloorShell title="Transporter Invoices" isLoading={false} isEmpty={false} docSend={{ objectType: 'transporter-invoice-inbox', sourceCard: 'dispatch', sourceRecord: { id: 'transporter-invoice-inbox' } }} />}
