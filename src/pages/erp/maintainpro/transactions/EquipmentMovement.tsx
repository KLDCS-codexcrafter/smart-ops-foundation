...
export function EquipmentMovement(_props: Props): JSX.Element {
  ...
  return (
    <div className="p-6 space-y-4" data-keyboard-form>
      ...
      <TallyVoucherHeader voucherTypeName="Equipment Movement" baseVoucherType="Memo" voucherFamily="movement" voucherNo="" voucherDate={new Date().toISOString().slice(0, 10)} status="draft" />
      <Card><CardContent className="p-4 space-y-3">
        ...
        <div className="space-y-1"><Label>From</Label><Input value={src} onChange={(e) => setSrc(e.target.value)} onKeyDown={onEnterNext} /></div>
        <div className="space-y-1"><Label>To</Label><Input value={dest} onChange={(e) => setDest(e.target.value)} onKeyDown={onEnterNext} /></div>
