 ...
 * @purpose     S38 IoT-Ready Foundation · Phase 2 Preview stub
    ...
    <div className="p-6 space-y-4">
      ...
      <Card className="p-6 space-y-2 opacity-70">
        <p className="text-sm text-muted-foreground">
          S38 Tier 3 stub · Telemetry ingestion endpoints for connected equipment with auto-ticket
          creation on threshold breach.
        </p>
