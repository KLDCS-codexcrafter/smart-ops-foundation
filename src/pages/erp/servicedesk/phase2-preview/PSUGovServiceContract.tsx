 ...
 * @purpose     S36 PSU/Gov Service Contract · Phase 2 Preview stub
    ...
    <div className="p-6 space-y-4">
      ...
      <Card className="p-6 space-y-2 opacity-70">
        <p className="text-sm text-muted-foreground">
          S36 Tier 3 stub · Custom contract templates for PSU and Government clients with extended SLA windows,
          mandatory escalation matrices, and audit-grade documentation.
        </p>
