 ...
 * @purpose     S37 Multi-Currency Export Service · Phase 2 Preview stub
    ...
    <div className="p-6 space-y-4">
      ...
      <Card className="p-6 space-y-2 opacity-70">
        <p className="text-sm text-muted-foreground">
          S37 Tier 3 stub · USD / EUR / GBP service-export invoicing with FEMA compliance hooks and
          forex realisation tracking.
        </p>
