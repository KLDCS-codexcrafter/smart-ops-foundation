 ...
 * @purpose Completeness guard — zero module-scope hardcoded entity literals in servicedesk-settings.
 */
import { describe, it, expect } from 'vitest';
import { readdirSync, readFileSync, statSync, existsSync } from 'node:fs';
import { join } from 'node:path';

const ROOT = join(process.cwd(), 'src/pages/erp/servicedesk/settings');
const FORBIDDEN = [
...
describe('CL-3c · servicedesk-settings hook-sweep guard', () => {
