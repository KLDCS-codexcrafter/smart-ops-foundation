 ...
 * @purpose Completeness guard — zero module-scope hardcoded entity literals in vendor-portal.
 */
import { describe, it, expect } from 'vitest';
import { readdirSync, readFileSync, statSync, existsSync } from 'node:fs';
import { join } from 'node:path';

const ROOT = join(process.cwd(), 'src/pages/erp/vendor-portal');
const FORBIDDEN = [
...
describe('CL-3c · vendor-portal hook-sweep guard', () => {
