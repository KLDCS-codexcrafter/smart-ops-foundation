 ...
 * @purpose Completeness guard — zero module-scope hardcoded entity literals in masters.
 */
import { describe, it, expect } from 'vitest';
import { readdirSync, readFileSync, statSync, existsSync } from 'node:fs';
import { join } from 'node:path';

const ROOT = join(process.cwd(), 'src/pages/erp/masters');
const FORBIDDEN = [
...
describe('CL-3c · masters hook-sweep guard', () => {
