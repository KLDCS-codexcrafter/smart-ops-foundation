 ...
 * @purpose Completeness guard — zero module-scope hardcoded entity literals in sitex.
 */
import { describe, it, expect } from 'vitest';
import { readdirSync, readFileSync, statSync } from 'node:fs';
import { join } from 'node:path';

const ROOT = join(process.cwd(), 'src/pages/erp/sitex');
const FORBIDDEN = [
...
describe('CL-3b · sitex hook-sweep guard', () => {
