 ...
 * @purpose Completeness guard — zero module-scope hardcoded entity literals in distributor-hub.
 */
import { describe, it, expect } from 'vitest';
import { readdirSync, readFileSync, statSync } from 'node:fs';
import { join } from 'node:path';

const ROOT = join(process.cwd(), 'src/pages/erp/distributor-hub');
const FORBIDDEN = [
...
describe('CL-3b · distributor-hub hook-sweep guard', () => {
