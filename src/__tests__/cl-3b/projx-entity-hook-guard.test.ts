 ...
 * @purpose Completeness guard — zero module-scope hardcoded entity literals in projx.
 */
import { describe, it, expect } from 'vitest';
import { readdirSync, readFileSync, statSync } from 'node:fs';
import { join } from 'node:path';

const ROOT = join(process.cwd(), 'src/pages/erp/projx');
const FORBIDDEN = [
...
describe('CL-3b · projx hook-sweep guard', () => {
