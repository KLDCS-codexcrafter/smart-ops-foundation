# CARD DEEP-DIVE · GATEFLOW
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Ops Hub · **Route:** `/erp/gateflow` · **Icon:** DoorOpen · **Registry id:** `gateflow`

---

## 1. What it is / what it's for
Gate management · vehicle in/out, gate passes, weighbridge integration. Interfaces with Procure360 GRN inward and Dispatch outward.

## 2. Where it lives
- **Route:** `/erp/gateflow`
- **Registry id:** `gateflow` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · GateFlow · verified at c30f161 · Operix Developer Handbook card series.*
