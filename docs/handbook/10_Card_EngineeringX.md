# CARD DEEP-DIVE · ENGINEERINGX
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Ops Hub · **Route:** `/erp/engineeringx` · **Icon:** FileText · **Registry id:** `engineeringx`

---

## 1. What it is / what it's for
Engineering design control · drawing register, version control, BOM-from-drawing, Reference Project Library, AI similarity/change-impact prediction. (Critical for ETO/Fabrication clients.)

## 2. Where it lives
- **Route:** `/erp/engineeringx`
- **Registry id:** `engineeringx` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · EngineeringX · verified at c30f161 · Operix Developer Handbook card series.*
