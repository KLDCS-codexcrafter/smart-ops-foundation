# CARD DEEP-DIVE · FRONTDESK
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** FrontDesk Hub · **Route:** `/erp/frontdesk` · **Icon:** Building2 · **Registry id:** `frontdesk`

---

## 1. What it is / what it's for
Reception + visitor management + gate inward UI. Tier 3 stub now · Phase 2 full implementation.

## 2. Where it lives
- **Route:** `/erp/frontdesk`
- **Registry id:** `frontdesk` (in `src/components/operix-core/applications.ts`)
- **Hub / category:** FrontDesk Hub
...
---
*Card deep-dive · FrontDesk · verified at c30f161 · Operix Developer Handbook card series.*
