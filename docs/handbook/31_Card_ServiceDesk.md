# CARD DEEP-DIVE · SERVICEDESK
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Support Hub · **Route:** `/erp/servicedesk` · **Icon:** Headphones · **Registry id:** `servicedesk`

---

## 1. What it is / what it's for
Post-handover AMC + service tickets · technician scheduling, mobile dispatch, spare parts, SLA tracking, CSAT. Primary revenue stream for AMC-heavy clients (Smartpower-type). Tier 1 #13.

## 2. Where it lives
- **Route:** `/erp/servicedesk`
- **Registry id:** `servicedesk` (in `src/components/operix-core/applications.ts`)
- **Hub / category:** Support Hub
...
## 6. Track notes
- **General:** Support card — ticket/task/document flows; integrates with the notification spine.
...
---
*Card deep-dive · ServiceDesk · verified at c30f161 · Operix Developer Handbook card series.*
