# CARD DEEP-DIVE · PRODUCTION
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Ops Hub · **Route:** `/erp/production` · **Icon:** Factory · **Registry id:** `production`

---

## 1. What it is / what it's for
Production planning + execution · Work Orders, routing, 8-stage shopfloor, capacity planning, OEE, wastage analysis, scheduling. Core manufacturing engine.

## 2. Where it lives
- **Route:** `/erp/production`
- **Registry id:** `production` (in `src/components/operix-core/applications.ts`)
...
- `ProductionConfigAutomation`
- `MobileProductionConfirmationPage`
...
---
*Card deep-dive · Production · verified at c30f161 · Operix Developer Handbook card series.*
