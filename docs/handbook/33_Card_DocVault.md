# CARD DEEP-DIVE · DOCVAULT
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Support Hub · **Route:** `/erp/docvault` · **Icon:** FileText · **Registry id:** `docvault`

---

## 1. What it is / what it's for
Versioned document storage · drawings, MOMs, certifications, ISO/IEC docs. Prerequisite for EngineeringX (drawing register lives here). Tier 1 #4.

## 2. Where it lives
- **Route:** `/erp/docvault`
- **Registry id:** `docvault` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · DocVault · verified at c30f161 · Operix Developer Handbook card series.*
