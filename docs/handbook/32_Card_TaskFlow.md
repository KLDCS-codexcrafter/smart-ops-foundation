# CARD DEEP-DIVE · TASKFLOW
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Support Hub · **Route:** `/erp/taskflow` · **Icon:** CheckSquare · **Registry id:** `taskflow`

---

## 1. What it is / what it's for
Generic task delegation + workflow · cross-department task assignment with approvals. Tier 3 stub now · Phase 2 full implementation.

## 2. Where it lives
- **Route:** `/erp/taskflow`
- **Registry id:** `taskflow` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · TaskFlow · verified at c30f161 · Operix Developer Handbook card series.*
