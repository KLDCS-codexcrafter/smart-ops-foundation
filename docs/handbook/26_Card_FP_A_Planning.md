# CARD DEEP-DIVE · FP&A / PLANNING
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Fin Hub · **Route:** `/erp/fpa-planning` · **Icon:** Target · **Registry id:** `fpa-planning`

---

## 1. What it is / what it's for
Financial Planning & Analysis hub · Annual Operating Plan (AOP) · 3-year strategic plan · revenue & cost target cascade corporate → entity → division → department. Homes Arc D.0 (Org Planning) and Arc D.1 (Budget / Forecast / Scenario).

## 2. Where it lives
- **Route:** `/erp/fpa-planning`
- **Registry id:** `fpa-planning` (in `src/components/operix-core/applications.ts`)
- **Hub / category:** Fin Hub
...
## 6. Track notes
- **General:** Financial card — entity-correctness and money-math (decimal helpers) are critical; audit-log every posting.
...
---
*Card deep-dive · FP&A / Planning · verified at c30f161 · Operix Developer Handbook card series.*
