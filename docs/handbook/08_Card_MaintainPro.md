# CARD DEEP-DIVE · MAINTAINPRO
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Ops Hub · **Route:** `/erp/maintainpro` · **Icon:** Wrench · **Registry id:** `maintainpro`

---

## 1. What it is / what it's for
Plant maintenance · machine breakdown logs, preventive maintenance schedules, AMC for own machines, spare parts consumption. Feeds Production capacity.

## 2. Where it lives
- **Route:** `/erp/maintainpro`
- **Registry id:** `maintainpro` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · MaintainPro · verified at c30f161 · Operix Developer Handbook card series.*
