# CARD DEEP-DIVE · RECEIVX
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Fin Hub · **Route:** `/erp/receivx` · **Icon:** TrendingUp · **Registry id:** `receivx`

---

## 1. What it is / what it's for
Receivables management · customer outstanding, collections, dunning, dispute tracking, customer credit limits.

## 2. Where it lives
- **Route:** `/erp/receivx`
- **Registry id:** `receivx` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · ReceivX · verified at c30f161 · Operix Developer Handbook card series.*
