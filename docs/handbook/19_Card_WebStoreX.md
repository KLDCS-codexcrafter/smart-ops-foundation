# CARD DEEP-DIVE · WEBSTOREX
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Sales Hub · **Route:** `/erp/webstorex` · **Icon:** ShoppingBag · **Registry id:** `webstorex`

---

## 1. What it is / what it's for
B2B/B2C e-commerce shopfront · distributor and customer self-service. MOAT #11. Sprint 149 (PIM + Catalog · publication wrapper · inventory master READ-ONLY · variants/brands/categories/settings).

## 2. Where it lives
- **Route:** `/erp/webstorex`
- **Registry id:** `webstorex` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · WebStoreX · verified at c30f161 · Operix Developer Handbook card series.*
