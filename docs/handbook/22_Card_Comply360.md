# CARD DEEP-DIVE · COMPLY360
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Fin Hub · **Route:** `/erp/comply360` · **Icon:** Shield · **Registry id:** `comply360`

---

## 1. What it is / what it's for
India + global statutory compliance · GST, TDS, TCS, E-invoice, E-way bill, ROC, MSME 43BH. Wraps existing FinCore compliance. Tier 4 deferred to Phase 1.4+.

## 2. Where it lives
- **Route:** `/erp/comply360`
- **Registry id:** `comply360` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · Comply360 · verified at c30f161 · Operix Developer Handbook card series.*
