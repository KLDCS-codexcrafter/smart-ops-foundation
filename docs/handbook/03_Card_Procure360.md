# CARD DEEP-DIVE · PROCURE360
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Ops Hub · **Route:** `/erp/procure-hub` · **Icon:** ShoppingCart · **Registry id:** `procure360`

---

## 1. What it is / what it's for
Procurement-to-Pay arc · vendor enquiry → 3-mode vendor selection → RFQ → quotation comparison → award → PO management. Feeds RequestX indents and Bill Passing.

## 2. Where it lives
- **Route:** `/erp/procure-hub`
- **Registry id:** `procure360` (in `src/components/operix-core/applications.ts`)
...
- `Procure360Page`
- `Procure360VendorAgreementsRegister`
- `Procure360VendorAgreementEntry`
...
---
*Card deep-dive · Procure360 · verified at c30f161 · Operix Developer Handbook card series.*
