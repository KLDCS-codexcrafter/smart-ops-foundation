# CARD DEEP-DIVE · DISPATCH HUB
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Dispatch Hub · **Route:** `/erp/dispatch` · **Icon:** PackageCheck · **Registry id:** `dispatch-hub`

---

## 1. What it is / what it's for
Internal department · inward & outward logistic operations · Delivery Memo, Packing Slip, GRN inward receipts, Sample/Demo outward issue, Outward Movement Report, Dispatch Exceptions. Works WITH stock. NOT transporter panel (see Logistics).

## 2. Where it lives
- **Route:** `/erp/dispatch`
- **Registry id:** `dispatch-hub` (in `src/components/operix-core/applications.ts`)
- **Hub / category:** Dispatch Hub
...
---
*Card deep-dive · Dispatch Hub · verified at c30f161 · Operix Developer Handbook card series.*
