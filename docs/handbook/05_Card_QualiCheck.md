# CARD DEEP-DIVE · QUALICHECK
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Ops Hub · **Route:** `/erp/qualicheck` · **Icon:** CheckSquare · **Registry id:** `qualicheck`

---

## 1. What it is / what it's for
Quality control module · incoming/in-process/final inspection · NCR, CAPA, MTC, FAI, welder qualification. ISO 9001 + IEC 17025 compliance.

## 2. Where it lives
- **Route:** `/erp/qualicheck`
- **Registry id:** `qualicheck` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · QualiCheck · verified at c30f161 · Operix Developer Handbook card series.*
