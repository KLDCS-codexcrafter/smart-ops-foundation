# CARD DEEP-DIVE · CUSTOMER HUB
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Sales Hub · **Route:** `/erp/customer-hub` · **Icon:** Heart · **Registry id:** `customer-hub`

---

## 1. What it is / what it's for
B2B/B2C customer portal + relationship management · customer master, opportunity pipeline, customer service requests, AMC visibility.

## 2. Where it lives
- **Route:** `/erp/customer-hub`
- **Registry id:** `customer-hub` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · Customer Hub · verified at c30f161 · Operix Developer Handbook card series.*
