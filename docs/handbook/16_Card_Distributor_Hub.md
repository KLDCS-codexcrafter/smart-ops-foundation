# CARD DEEP-DIVE · DISTRIBUTOR HUB
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Sales Hub · **Route:** `/erp/distributor-hub` · **Icon:** Store · **Registry id:** `distributor-hub`

---

## 1. What it is / what it's for
B2B distributor portal + management · scheme management, secondary sales tracking, distributor hierarchy, primary/secondary order pipelines, distributor live tracker.

## 2. Where it lives
- **Route:** `/erp/distributor-hub`
- **Registry id:** `distributor-hub` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · Distributor Hub · verified at c30f161 · Operix Developer Handbook card series.*
