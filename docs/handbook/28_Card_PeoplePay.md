# CARD DEEP-DIVE · PEOPLEPAY
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Pay Hub · **Route:** `/erp/pay-hub` · **Icon:** Users · **Registry id:** `peoplepay`

---

## 1. What it is / what it's for
Full HR + payroll · attendance, leaves, payroll, statutory compliance (PF/ESI/LWF/PT), employee master, contract manpower, shift master, learning & development, exit/F&F.

## 2. Where it lives
- **Route:** `/erp/pay-hub`
- **Registry id:** `peoplepay` (in `src/components/operix-core/applications.ts`)
- **Hub / category:** Pay Hub
...
- `PeoplePay payroll surfaces (PayHub)`
...
---
*Card deep-dive · PeoplePay · verified at c30f161 · Operix Developer Handbook card series.*
