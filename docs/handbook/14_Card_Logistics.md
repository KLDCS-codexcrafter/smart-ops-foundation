# CARD DEEP-DIVE · LOGISTICS
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Ops Hub · **Route:** `/erp/logistics` · **Icon:** Truck · **Registry id:** `logistics`

---

## 1. What it is / what it's for
Transporter panel · LR tracking, POD, courier management, freight reconciliation, transporter scorecard, dispute queue. External-party coordination. (Distinct from Dispatch Hub which handles inward/outward stock operations.)

## 2. Where it lives
- **Route:** `/erp/logistics`
- **Registry id:** `logistics` (in `src/components/operix-core/applications.ts`)
...
- `Logistics dispatch/route surfaces`
...
---
*Card deep-dive · Logistics · verified at c30f161 · Operix Developer Handbook card series.*
