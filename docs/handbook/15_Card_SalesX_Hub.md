# CARD DEEP-DIVE · SALESX HUB
## Operix Developer Handbook — Card Series

**Verified against:** registry `applications.ts` + card surfaces at freeze `c30f161`.
**Hub:** Sales Hub · **Route:** `/erp/salesx` · **Icon:** TrendingUp · **Registry id:** `salesx`

---

## 1. What it is / what it's for
Sales lifecycle management · Enquiry → Quotation → Sales Order → Sample/Demo Outward · stock reservations · 6-role mobile suite (Salesman, Telecaller, Supervisor, Manager, Distributor, Customer) · 14 reports.

## 2. Where it lives
- **Route:** `/erp/salesx`
- **Registry id:** `salesx` (in `src/components/operix-core/applications.ts`)
...
---
*Card deep-dive · SalesX Hub · verified at c30f161 · Operix Developer Handbook card series.*
